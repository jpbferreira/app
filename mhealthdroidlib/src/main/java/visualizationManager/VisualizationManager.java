...
public class VisualizationManager extends Activity {
	 ...
	 * @param scalable Boolean that indicates if it's scalable or not
	 */
	 ...
	 * If the graph doesn't exist a null exception will be thrown.
	 * @param nameGraph Is the graph's name
	 * @param showLegend Boolean that indicates if shows the legend or not
	 */
	 ...
	 * If the graph doesn't exist a null exception will be thrown.
	 * @param nameGraph Is the graph's name
	 * @param align The align where the legend must be placed
	 */
